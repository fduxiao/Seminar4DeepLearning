...
def main():
    ...
    train_writer = tf.summary.FileWriter('./tensorboard/normal' + '/train', sess.graph)
    ...
    for i in range(start, 20000):
        ...
        if i % 500 == 0:
            ...
            saver.save(sess, "./checkpoints/normal.ckpt")
            saver.save(sess, './checkpoints/normal_%d.ckpt' % i)
